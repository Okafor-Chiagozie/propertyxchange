...
import user1 from "../assets/client7.jpg"
import user2 from "../assets/client8.jpg"
import property1 from "../assets/house2.jpg"
import property2 from "../assets/house3.jpg"
import property3 from "../assets/house4.jpg"
import property4 from "../assets/house5.jpg"
          ...
          <div className=' rounded-lg p-4 bg-white ring-1 ring-slate-900/5'>
            <div className='flexBetween'>
              <div className='flexCenter gap-x-2'>
                ...
                <h5 className='bold-14'>Daniel Leonard</h5>
              </div>
            ...
            <div className='flex gap-x-1 text-orange-500 mt-5 mb-1 text-xs'>
              <FaStar />
              <FaStar />
              <FaStar />
              <FaStar />
          ...
          <div className=' rounded-lg p-4 bg-white ring-1 ring-slate-900/5'>
            <div className='flexBetween'>
              <div className='flexCenter gap-x-2'>
                ...
                <h5 className='bold-14'>Micheal Steven</h5>
              </div>
              <div className='bg-secondary text-white rounded-full flexCenter gap-x-2 p-1 px-2 text-xs font-semibold'>
                <FaCheck />
                Verified
